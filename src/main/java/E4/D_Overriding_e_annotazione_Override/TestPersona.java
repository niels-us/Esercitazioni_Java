...
public class TestPersona {
    public static void main() {
        ...
        //17. Overriding multiplo
        Impiegato impiegato1 = new Impiegato("Marco", 25, 1500);
        Manager manager1 = new Manager("Elena", 35, 2500.0, 800.0);
        Director director = new Director("Niels", 40, 3500.0, 1500.0, 2000.0);

        System.out.println("Stipendio Impiegato: " + impiegato1.getSalary() + "€");
        System.out.println("Stipendio Manager: " + manager1.getSalary() + "€");
        System.out.println("Stipendio Director: " + director.getSalary() + "€");

        //18. Uso combinato di super e override
        //19. Polimorfismo gerarchico

        Impiegato[] staff1 = new Impiegato[3];
        // Popoliamo l'array con tipi di oggetto misti
        staff1[0] = new Impiegato("Mario Rossi", 25, 1500.0);
        staff1[1] = new Manager("Niels Salvador", 30, 3000.0, 1000.0);
        staff1[2] = new Director("Elena Bianchi", 40, 8000.0, 2000, 1000);

        // 3. Iterazione polimorfica sul personale
        for (Impiegato empie : staff1) {
            // La JVM controlla il tipo REALE dell'oggetto in memoria a runtime:
            // - Per staff[0] esegue Impiegato.getSalary() -> 1500.0
            // - Per staff[1] esegue Manager.getSalary()  -> 2500.0 + 800.0
            // - Per staff[2] esegue Director.getSalary() -> 3500.0 + 1500.0 + 2000.0
            System.out.println("Ruolo: " + empie.getClass().getSimpleName() +
                    " | Nome: " + empie.getNome() +
                    " | Salario Totale: " + empie.getSalary() + "€");
        }

        //20. Override parziale e metodo aggiuntivo
        Impiegato impiegato2 = new Impiegato("Marco", 25, 1500);
        Manager manager2 = new Manager("Elena", 35, 2500.0, 800.0);
        //impiegato2.va
        manager2.valutaDipendente();
